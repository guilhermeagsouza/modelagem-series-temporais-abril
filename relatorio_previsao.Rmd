...
Considerou-se a métrica MAPE (erro absoluto percentual médio) como critério de avaliação dentro dos dados de validação.
...
A série apresentou Houve um aumento da basal, dobrando de patamar.
