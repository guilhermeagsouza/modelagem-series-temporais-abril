...
###############################################################################
dados_modelo_teste <- readr::read_rds("dados-modelo-teste/saude.Rda")
...
PREVISAO_SARIMA <- readr::read_rds("previsao-ajustados-sarima/saude.Rda") %>% 
...
pesos %>% write_rds("previsao-modelos-ensemble/pesos_ensemble_saude.Rda")

################################################################################
previsao <- readr::read_rds("previsao-sessoes-sites/tbl_previsao_saude.Rda") %>% 
