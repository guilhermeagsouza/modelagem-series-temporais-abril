...
###############################################################################
dados_modelo_teste <- readr::read_rds("dados-modelo-teste/veja.Rda")
...
PREVISAO_SARIMA <- readr::read_rds("previsao-ajustados-sarima/veja.Rda") %>% 
...
pesos %>% write_rds("previsao-modelos-ensemble/pesos_ensemble_veja.Rda")

################################################################################
previsao <- readr::read_rds("previsao-sessoes-sites/tbl_previsao_veja.Rda") %>% 
