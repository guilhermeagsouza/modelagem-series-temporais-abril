...
#Lendo base de dados superinteressante
...
previsao_superinteressante %>% 
  readr::write_rds("dados-ajustados-teste/previsao-treino-sarima-superinteressante.Rda")
...
previsao_sarima_foradaamostra %>% 
  readr::write_rds("previsao-modelos-sarima/previsao_superinteressante.Rda")
