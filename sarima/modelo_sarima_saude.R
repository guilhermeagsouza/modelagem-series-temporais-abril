...
previsao_saude %>% 
  readr::write_rds("dados-ajustados-teste/previsao-treino-sarima-saude.Rda")
...
previsao_sarima_foradaamostra %>% 
  readr::write_rds("previsao-modelos-sarima/previsao_saude.Rda")
