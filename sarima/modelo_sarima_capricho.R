...
previsao_capricho %>% 
  readr::write_rds("dados-ajustados-teste/previsao-treino-sarima-capricho.Rda")
...
previsao_sarima_foradaamostra %>% 
  readr::write_rds("previsao-modelos-sarima/previsao_capricho.Rda")
