...
previsao_veja %>% 
  readr::write_rds("dados-ajustados-teste/previsao-treino-sarima-veja.Rda")
...
previsao_sarima_foradaamostra %>% 
  readr::write_rds("previsao-modelos-sarima/previsao_veja.Rda")
