...
previsao_claudia %>% 
  readr::write_rds("dados-ajustados-teste/previsao-treino-sarima-claudia.Rda")
...
previsao_sarima_foradaamostra %>% 
  readr::write_rds("previsao-modelos-sarima/previsao_claudia.Rda")
