...
###############################################################################
dados_modelo_teste <- readr::read_rds("dados-modelo-teste/capricho.Rda")
...
PREVISAO_SARIMA <- readr::read_rds("previsao-ajustados-sarima/capricho.Rda") %>% 
...
pesos %>% write_rds("previsao-modelos-ensemble/pesos_ensemble_capricho.Rda")

################################################################################
previsao <- readr::read_rds("previsao-sessoes-sites/tbl_previsao_capricho.Rda") %>% 
