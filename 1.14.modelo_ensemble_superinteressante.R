...
###############################################################################
dados_modelo_teste <- readr::read_rds("dados-modelo-teste/superinteressante.Rda")
...
PREVISAO_SARIMA <- readr::read_rds("previsao-ajustados-sarima/superinteressante.Rda") %>% 
...
pesos %>% write_rds("previsao-modelos-ensemble/pesos_ensemble_superinteressante.Rda")

################################################################################
previsao <- readr::read_rds("previsao-sessoes-sites/tbl_previsao_superinteressante.Rda") %>% 
